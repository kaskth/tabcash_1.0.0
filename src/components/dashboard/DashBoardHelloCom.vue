        ...
        >
          ...
          <div class="col flex row justify-between items-center q-px-md text-white">
            <div class="flex column text-center">
              ...
              <span class="text-h6">{{store.creditcard.balance}}.00</span>
            </div>
            <div class="flex column text-center">
...
<!--      col2-->
      ...
      <div class="col flex column justify-center q-gutter-y-md">
        ...
        <span class="text-h4 text-weight-bold">{{store.wallet.balance}}.00</span>
        ...
        <div class="flex q-gutter-x-md">
          ...
          <q-btn
              ...
              icon="join_right"
          >
            <q-tooltip>Transfer to credit card</q-tooltip>
          </q-btn>
        </div>
